        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                ...
                <div class="grid lg:grid-cols-4 grid-cols-1 lg:space-x-2 lg:space-y-0">
                    ...
                    <a href="{{ route('ratings.index') }}"><x-button class="mb-2">{{__('Create Ratings')}}</x-button></a>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 mt-10">
                ...
                <ul class="max-w-md space-y-1 text-gray-500 list-inside text-lg dark:text-gray-400">
                    ...
                    <li class="flex items-center">
                        <svg @class(['text-gray-500' => ! $rating, 'text-green-500' => $rating, 'w-3.5', 'h-3.5', 'me-2', 'flex-shrink-0']) aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                        </svg>
