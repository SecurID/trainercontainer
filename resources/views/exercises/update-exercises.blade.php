            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="{{ route('exercises.update', $exercise->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <input type="text" class="form-input rounded-md shadow-sm w-full" placeholder="{{ __('Name') }}" name="name" value="{{ $exercise->name }}">
                        <input type="text" class="form-input rounded-md shadow-sm w-full" placeholder="{{ __('Focus') }}" name="focus" value="{{ $exercise->focus }}">
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                        <input type="text" class="form-input rounded-md shadow-sm w-full" placeholder="{{ __('Material') }}" name="material" value="{{ $exercise->material }}">
                        <input type="text" class="form-input rounded-md shadow-sm w-full" placeholder="{{ __('Duration') }}" name="duration" value="{{ $exercise->duration }}">
                        <input type="text" class="form-input rounded-md shadow-sm w-full mr-2" placeholder="{{ __('Intensity') }}" name="intensity" value="{{ $exercise->intensity }}">
                    </div>
