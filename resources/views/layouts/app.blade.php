            ...
            <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <x-jet-nav-link href="/practices" :active="request()->routeIs(['practices.index', 'practices.create'])">
                                    {{ __('Practices') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/exercises" :active="request()->routeIs(['exercises.index', 'exercises.create'])">
                                    {{ __('Excercises') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/players" :active="request()->routeIs(['players.index', 'players.create'])">
                                    {{ __('Players') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/ratings" :active="request()->routeIs(['ratings.index', 'ratings.create'])">
                                    {{ __('Create Ratings') }}
                                </x-jet-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <x-jet-responsive-nav-link href="/practices" :active="request()->routeIs(['practices.index', 'practices.create'])">
                            {{ __('Practices') }}
                        </x-jet-responsive-nav-link>
                        <x-jet-responsive-nav-link href="/exercises" :active="request()->routeIs(['exercises.index', 'exercises.create'])">
                            {{ __('Excercises') }}
                        </x-jet-responsive-nav-link>
                        <x-jet-responsive-nav-link href="/players" :active="request()->routeIs(['players.index', 'players.create'])">
                            {{ __('Players') }}
                        </x-jet-responsive-nav-link>
                        <x-jet-responsive-nav-link href="/ratings" :active="request()->routeIs(['ratings.index', 'ratings.create'])">
                            {{ __('Create Ratings') }}
                        </x-jet-responsive-nav-link>
                    </div>
